# Parse-level Visium-only teaching example. It is not a universal spatial recipe
# and is not data-verified. Compile it through SKILL.md input, artifact, statistical,
# checkpoint, and environment contracts before use. Recipes do not install packages.
# Reference API family: matplotlib 3.8+, numpy 1.26+, scanpy 1.10+, squidpy 1.3+.
