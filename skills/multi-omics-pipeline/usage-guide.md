...
Declare `MOFA2`, `mixOmics`, `SNFtool`, `omicade4`, and plotting packages in the task environment plan. Provision and lock them through the EnvironmentManager; do not install packages from analysis recipes.
...
| design | objective-dependent | Predeclare and compare sensitivity variants such as 0.1 and 0.5; neither is universal |
...
- Do not use a universal 5% cutoff. Predeclare a variance/stability/technical-covariate rule and report sensitivity to stricter and looser thresholds.
