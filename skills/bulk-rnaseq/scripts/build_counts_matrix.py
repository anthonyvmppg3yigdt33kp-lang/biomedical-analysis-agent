...
Requires declared task-environment dependencies: pandas; Salmon mode also needs pytximport.
"""
...
def build_from_salmon(quant_dir: Path, tx2gene: Path) -> pd.DataFrame:
    ...
    try:
        ...
        sys.exit("Salmon mode needs pytximport; ask the task EnvironmentManager to provision the declared dependency")
