...
Declare and pin `fastqc`, `fastp`, `trim-galore`, `star=2.7.11b`, `salmon=1.10.3`, `subread`, `multiqc`, and `rseqc` in the task environment plan. Ask the EnvironmentManager to provision and freeze them; do not install from an analysis recipe.
